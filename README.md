...
4. first run (`:Lazy sync`, `:checkhealth`)
5. tmux integration via **`tol-new`**
6. installing + registering the **`lvim-new.desktop`** entry ("LunarVim New")
7. **`mimeopen_bg`** — how `lvim-new` is offered as the *second* option in the
